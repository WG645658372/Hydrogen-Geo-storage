...
pair_coeff 	14	14    0.072896 2.958
...
variable 	      type14 atom "type==14"
group 	            type14 dynamic ggcmc var type14
variable          nH2 equal count(type14)
compute           mtem type14 temp/com
compute_modify    mtem dynamic/dof yes

fix               1  wall nve/noforce  # move linear 0 0 0

# gcmc
fix               2 ggcmc gcmc 100 100 100 14 29494  ${T} 1 0.5 region soall pressure ${Patm} fugacity_coeff ${fe} group ggcmc
                          
fix               3 type14 nvt temp ${T}  ${T}  100 
...
compute         layers ggcmc chunk/atom bin/1d z lower 0.1 units box bound z -55 55

fix		4 ggcmc ave/chunk 10 100 1000 layers v_x file profile.density
run               3000000

write_data        C199H148N2O9_gcmc4ns.data
