...
read_data          C39_1020waternvt1ns.data
...
thermo            1000
thermo_style      custom step c_mtem c_mwtem ke atoms v_nH2  

run               100000
write_data        C39_H2_1020watergcmc0.1ns.data
run               100000
write_data        C39_H2_1020watergcmc0.2ns.data
run               100000
write_data        C39_H2_1020watergcmc0.3ns.data
run               100000
write_data        C39_H2_1020watergcmc0.4ns.data
run               100000
write_data        C39_H2_1020watergcmc0.5ns.data
